...
export default function ProductCard({ product, onAdd, isFavorite = false, onToggleFavorite, allProducts, onAddProduct, onToggleFavoriteProduct, isFavoriteId }) {
  ...
  const hasToggleFavorite = !!(onToggleFavorite || onToggleFavoriteProduct)
  const handleToggleFavorite = (e) => {
    e.stopPropagation()
    if (onToggleFavoriteProduct) onToggleFavoriteProduct(product.id)
    else if (onToggleFavorite) onToggleFavorite()
  }
